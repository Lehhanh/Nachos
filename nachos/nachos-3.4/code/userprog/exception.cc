...
ExceptionHandler(ExceptionType which)
{
    ...
    //printf("Vao exception, type: %d\n", type);
    int op1, op2, number, numbytes, i, result, temp, firstNumIndex;
    ...
    int MAX_BUFFER = 255;
    int virtAddr, charcount, fileID, prevPos, newPos, virtAddr1, pos;
    switch(which){
    	case NoException:
    		return;
